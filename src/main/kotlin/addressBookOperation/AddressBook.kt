...
fun main() {
  ...
  val c1 = addressBookObject.executCommand(AddContactCommand(AddContactCreateRequest("Parth","Raval",
    ...
    mutableListOf("Office", "Friends", "Family")))) as Contact
  println(c1)

  val c2 = addressBookObject.executCommand(AddContactCommand(AddContactCreateRequest("Hamza","Malik",
    ...
    mutableListOf("Office", "Friends")))) as Contact
  println(c2)

  val c3 = addressBookObject.executCommand(AddContactCommand(AddContactCreateRequest("Bhagvat","Jadaja",
    ...
    mutableListOf("Office", "Family"))))as Contact
  println(c3)

  val c4 = addressBookObject.executCommand(AddContactCommand(AddContactCreateRequest("Shivam","Chavda",
  ...
  val updatedC1 = addressBookObject.executCommand(UpdateContactCommand(UpdateContactRequest( c1.id,"Black","Raval",
    mutableMapOf("Work" to "parth.raval@vayana.com", "Personal" to "pr73pdpu@gmail.com"),
    mutableMapOf("Work" to "7096447878", "Personal" to "7031013939"),
    mutableMapOf("Office" to "Baroda", "Home" to "Bhavnagar"),
    mutableListOf("Office", "Friends", "Family")))) as Contact
  ...
  val Collage = addressBookObject.executCommand(AddGroupCommand(AddGroupRequest(
    "PDEU Boys",
    mutableListOf(c1,c2,c3)
  ))) as Group
  val School = addressBookObject.executCommand(AddGroupCommand(
    AddGroupRequest(
    "Vidhiya Dhish",
    mutableListOf(c1,c4)
  )
